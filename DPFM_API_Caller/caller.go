...
import (
	"bufio"
	"context"
	dpfm_api_input_reader "data-platform-api-delivery-notice-edi-for-smes-csv-converter-rmq-kube/DPFM_API_Input_Reader"
	dpfm_api_output_formatter "data-platform-api-delivery-notice-edi-for-smes-csv-converter-rmq-kube/DPFM_API_Output_Formatter"
	"data-platform-api-delivery-notice-edi-for-smes-csv-converter-rmq-kube/config"
	"io/ioutil"
	"os"
...
func (c *DPFMAPICaller) setHeaderData(deliveryMessage *dpfm_api_output_formatter.DataConcatenation, f *dpfm_api_input_reader.Request, apiErr error) *dpfm_api_output_formatter.DeliverySDC {
	...
	return &dpfm_api_output_formatter.DeliverySDC{
		...
		ServiceLabel:        "FUNCTION_DELIVERY_NOTICE_EDI_FOR_SMES_DATA_CONCATENATION",
		APIType:             f.APIType,
		DataConcatenation:   deliveryMessage,
...
func (c *DPFMAPICaller) createHeaderData(f *dpfm_api_input_reader.Request, apiErr error) *dpfm_api_output_formatter.DeliverySDC {
	var apiProcessingError *string = nil
	if apiErr != nil {
		e := apiErr.Error()
		apiProcessingError = &e
